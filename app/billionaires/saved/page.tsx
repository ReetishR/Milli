    ...
    <main className="min-h-screen bg-black text-white">
      <div className="mx-auto max-w-4xl px-6 py-8">
        <div className="flex items-center justify-between gap-4">
          <Link href="/billionaires" className="text-sm opacity-80 hover:opacity-100">
            Back
          </Link>
        ...
        <h1 className="mt-6 text-3xl font-semibold">Saved billionaire profiles</h1>
        ...
        <div className="mt-6 space-y-3">
          {profiles.length === 0 && (
            <div className="rounded-xl border border-white/10 bg-white/5 p-4 text-sm opacity-80">
              No saved profiles yet. Generate a few at /billionaires first.
            </div>
          )}
